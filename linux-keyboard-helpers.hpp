...
#define VKEY_NOTIFICATION_BACK 0xA6              // Windows 2000/XP: Notification Back key
#define VKEY_NOTIFICATION_FORWARD 0xA7           // Windows 2000/XP: Notification Forward key
#define VKEY_NOTIFICATION_REFRESH 0xA8           // Windows 2000/XP: Notification Refresh key
#define VKEY_NOTIFICATION_STOP 0xA9              // Windows 2000/XP: Notification Stop key
#define VKEY_NOTIFICATION_SEARCH 0xAA            // Windows 2000/XP: Notification Search key
#define VKEY_NOTIFICATION_FAVORITES 0xAB         // Windows 2000/XP: Notification Favorites key
#define VKEY_NOTIFICATION_HOME 0xAC              // Windows 2000/XP: Notification Start and Home key
...
static uint32_t KeyboardCodeFromXKeysym(unsigned int keysym)
{
	...
	case XF86XK_Back:
		return VKEY_NOTIFICATION_BACK;
	case XF86XK_Forward:
		return VKEY_NOTIFICATION_FORWARD;
	case XF86XK_Reload:
		return VKEY_NOTIFICATION_REFRESH;
	case XF86XK_Stop:
		return VKEY_NOTIFICATION_STOP;
	case XF86XK_Search:
		return VKEY_NOTIFICATION_SEARCH;
	case XF86XK_Favorites:
		return VKEY_NOTIFICATION_FAVORITES;
	case XF86XK_HomePage:
		return VKEY_NOTIFICATION_HOME;

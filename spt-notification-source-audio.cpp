...
void NotificationSource::EnumAudioStreams(obs_source_enum_proc_t cb, void *param)
{
...
bool NotificationSource::AudioMix(uint64_t *ts_out, struct audio_output_data *audio_output, size_t channels,
			     size_t sample_rate)
{
